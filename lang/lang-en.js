window.translations = {
    ...
    skillsHeader1: "Clean Code",
    skillsHeader2: "Front-End",
    skillsHeader3: "RWD",
    skillsHeader4: "CMS/SQL",
    skillsHeader5: "Git/Teamwork",
    skillsText1: "Writing clean code is one of the most important qualities for me. I think that this is crucial in order to achieve the best possible efficiency. I try to make my code readable and organized. Care for the code is the basis for me!",
    skillsText2: "When I coding the appearance of the website, I feel fulfilled and pay maximum attention to it's implementation. Writing web applications isn't a problem for me. Thanks to my experience, I'm not afraid of challenges and take on more and more difficult tasks.",
    skillsText3: "I use the 'mobile-first' method, but I can also code the other way around. Most people use mobile devices. This makes me take care of every detail to adapt my website to each device. Whether it's a phone, tablet or computer, my site is always up to date.",
    skillsText4: "For 3 years I worked as a website administrator on the IPS 4.x engine. I took care of the proper functioning and security of the website, introducing modifications and implementing user suggestions. I worked with databases and was fluent in MySQL using queries.",
    skillsText5: "Thanks to my interpersonal skills, I get along great in a team and I like working in a group. I like working with GIT, presenting and describing my work. I think it's a great tool that every programmer should know!",
